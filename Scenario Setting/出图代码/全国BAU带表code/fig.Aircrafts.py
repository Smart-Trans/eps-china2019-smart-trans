...
start_year_sectors = {
    "Gasoline": "SYVbT Start Year Vehicles by Technology.*aircraft.*gasoline vehicle.",
    "Diesel": "SYVbT Start Year Vehicles by Technology.*aircraft.*diesel vehicle.",
    "Natural Gas": "SYVbT Start Year Vehicles by Technology.*aircraft.*natural gas vehicle.",
    "LPG": "SYVbT Start Year Vehicles by Technology.*aircraft.*LPG vehicle.",
    "PHV": "SYVbT Start Year Vehicles by Technology.*aircraft.*plugin hybrid vehicle.",
    "BEV": "SYVbT Start Year Vehicles by Technology.*aircraft.*battery electric vehicle.",
    "Hydrogen": "SYVbT Start Year Vehicles by Technology.*aircraft.*hydrogen vehicle."
}

bau_sectors = {
    "Gasoline": "BAU Vehicles.*aircraft.*gasoline vehicle.",
    "Diesel": "BAU Vehicles.*aircraft.*diesel vehicle.",
    "Natural Gas": "BAU Vehicles.*aircraft.*natural gas vehicle.",
    "LPG": "BAU Vehicles.*aircraft.*LPG vehicle.",
    "PHV": "BAU Vehicles.*aircraft.*plugin hybrid vehicle.",
    "BEV": "BAU Vehicles.*aircraft.*battery electric vehicle.",
    "Hydrogen": "BAU Vehicles.*aircraft.*hydrogen vehicle."
}
...
def plot_sector_energy_consumption(processed_data, output_folder):
    ...
    output_path = f"{output_folder}/Aircrafts无标题.png"
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    print(f"Chart saved to: {output_path}")

    plt.title(titles,size=18)
    output_path = f"{output_folder}/Aircrafts.png"
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.close()
    print(f"Chart saved to: {output_path}")
