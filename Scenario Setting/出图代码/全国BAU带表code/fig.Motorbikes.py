...
start_year_sectors = {
    "Gasoline": "SYVbT Start Year Vehicles by Technology.*motorbikes.*gasoline vehicle.",
    "Diesel": "SYVbT Start Year Vehicles by Technology.*motorbikes.*diesel vehicle.",
    "Natural Gas": "SYVbT Start Year Vehicles by Technology.*motorbikes.*natural gas vehicle.",
    "LPG": "SYVbT Start Year Vehicles by Technology.*motorbikes.*LPG vehicle.",
    "PHV": "SYVbT Start Year Vehicles by Technology.*motorbikes.*plugin hybrid vehicle.",
    "BEV": "SYVbT Start Year Vehicles by Technology.*motorbikes.*battery electric vehicle.",
    "Hydrogen": "SYVbT Start Year Vehicles by Technology.*motorbikes.*hydrogen vehicle."
}

bau_sectors = {
    "Gasoline": "BAU Vehicles.*motorbikes.*gasoline vehicle.",
    "Diesel": "BAU Vehicles.*motorbikes.*diesel vehicle.",
    "Natural Gas": "BAU Vehicles.*motorbikes.*natural gas vehicle.",
    "LPG": "BAU Vehicles.*motorbikes.*LPG vehicle.",
    "PHV": "BAU Vehicles.*motorbikes.*plugin hybrid vehicle.",
    "BEV": "BAU Vehicles.*motorbikes.*battery electric vehicle.",
    "Hydrogen": "BAU Vehicles.*motorbikes.*hydrogen vehicle."
}
...
def plot_sector_energy_consumption(processed_data, output_folder):
    ...
    output_path = f"{output_folder}/Motorbikes无标题.png"
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    print(f"Chart saved to: {output_path}")
    
    plt.title(titles,size=18)
    output_path = f"{output_folder}/Motorbikes.png"
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.close()
    print(f"Chart saved to: {output_path}")
