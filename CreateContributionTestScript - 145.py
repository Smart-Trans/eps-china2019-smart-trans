...
(False,"Minimum Required ZEV Sales Percentage[passenger,LDVs]","Zero-Emission Vehicle Sales Standard - Passenger Cars and SUVs",[0,1],"ZEV Sales Standard"),
(False,"Minimum Required ZEV Sales Percentage[freight,LDVs]","Zero-Emission Vehicle Sales Standard - Freight Light and Medium Commercial Trucks",[0,1],"ZEV Sales Standard"),
(False,"Minimum Required ZEV Sales Percentage[passenger,HDVs]","Zero-Emission Vehicle Sales Standard - Passenger Buses",[0,1],"ZEV Sales Standard"),
(False,"Minimum Required ZEV Sales Percentage[freight,HDVs]","Zero-Emission Vehicle Sales Standard - Freight Heavy Duty Trucks",[0,1],"ZEV Sales Standard"),
(False,"Minimum Required ZEV Sales Percentage[passenger,rail]","Zero-Emission Vehicle Sales Standard - Passenger Rail",[0,1],"ZEV Sales Standard"),
(False,"Minimum Required ZEV Sales Percentage[freight,rail]","Zero-Emission Vehicle Sales Standard - Freight Rail",[0,1],"ZEV Sales Standard"),
(False,"Minimum Required ZEV Sales Percentage[passenger,motorbikes]","Zero-Emission Vehicle Sales Standard - Passenger Motorbikes",[0,1],"ZEV Sales Standard"),
(False,"Minimum Required ZEV Sales Percentage[freight,motorbikes]","Zero-Emission Vehicle Sales Standard - Freight Motorbikes",[0,1],"ZEV Sales Standard"),
(False,"Boolean Use Non BAU ZEV Qualifying Vehicle Defintions","Non BAU ZEV Qualifying Vehicles",[0,1],"ZEV Sales Standard"),
...
(False,"Percentage Additional Improvement of Fuel Economy Std[passenger,LDVs]","Fuel Economy Standard - Passenger Cars and SUVs",[0,1],"Vehicle Fuel Economy Standards"),
(False,"Percentage Additional Improvement of Fuel Economy Std[freight,LDVs]","Fuel Economy Standard - Freight Light and Medium Commercial Trucks",[0,1],"Vehicle Fuel Economy Standards"),
(False,"Percentage Additional Improvement of Fuel Economy Std[passenger,HDVs]","Fuel Economy Standard - Passenger Buses",[0,1],"Vehicle Fuel Economy Standards"),
(False,"Percentage Additional Improvement of Fuel Economy Std[freight,HDVs]","Fuel Economy Standard - Freight Heavy Duty Trucks",[0,1],"Vehicle Fuel Economy Standards"),
...
(False,"Percentage Additional Improvement of Fuel Economy Std[passenger,rail]","Fuel Economy Standard - Passenger Rail",[0,1],"Vehicle Fuel Economy Standards"),
(False,"Percentage Additional Improvement of Fuel Economy Std[freight,rail]","Fuel Economy Standard - Freight Rail",[0,1],"Vehicle Fuel Economy Standards"),
(False,"Percentage Additional Improvement of Fuel Economy Std[passenger,ships]","Fuel Economy Standard - Passenger Recreational boats",[0,1],"Vehicle Fuel Economy Standards"),
(False,"Percentage Additional Improvement of Fuel Economy Std[freight,ships]","Fuel Economy Standard - Freight Cargo ships",[0,1],"Vehicle Fuel Economy Standards"),
...
(False,"Percent of Travel Demand Shifted to Other Modes or Eliminated[passenger,LDVs]","Mode Shifting - Passenger Cars and SUVs",[0,0.26],"Mode Shifting"),
(False,"Percent of Travel Demand Shifted to Other Modes or Eliminated[passenger,aircraft]","Mode Shifting - Passenger Commercial flights",[0,0.26],"Mode Shifting"),
...
(False,"Percent of Travel Demand Shifted to Other Modes or Eliminated[freight,HDVs]","Mode Shifting - Freight Heavy Duty Trucks",[0,0.26],"Mode Shifting"),

# Buildings and Appliances Sector Policies
(False,"Fraction of New Bldg Components Shifted to Other Fuels[heating,urban residential]","Building Component Electrification - Heating Urban Residential",[0,1],"Building Component Electrification"),
(False,"Fraction of New Bldg Components Shifted to Other Fuels[appliances,urban residential]","Building Component Electrification - Appliances Urban Residential",[0,1],"Building Component Electrification"),
...
(False,"Fraction of New Bldg Components Shifted to Other Fuels[heating,rural residential]","Building Component Electrification - Heating Rural Residential",[0,1],"Building Component Electrification"),
(False,"Fraction of New Bldg Components Shifted to Other Fuels[appliances,rural residential]","Building Component Electrification - Appliances Rural Residential",[0,1],"Building Component Electrification"),
...
(False,"Fraction of New Bldg Components Shifted to Other Fuels[heating,commercial]","Building Component Electrification - Heating Commercial",[0,1],"Building Component Electrification"),
(False,"Fraction of New Bldg Components Shifted to Other Fuels[appliances,commercial]","Building Component Electrification - Appliances Commercial",[0,1],"Building Component Electrification"),
...
(False,"Reduction in E Use Allowed by Component Eff Std[heating,urban residential]","Building Energy Efficiency Standards - Heating Urban Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,urban residential]","Building Energy Efficiency Standards - Cooling and Ventilation Urban Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[envelope,urban residential]","Building Energy Efficiency Standards - Envelope Urban Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[lighting,urban residential]","Building Energy Efficiency Standards - Lighting Urban Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[appliances,urban residential]","Building Energy Efficiency Standards - Appliances Urban Residential",[0,0.75],"Building Energy Efficiency Standards"),
...
(False,"Reduction in E Use Allowed by Component Eff Std[heating,rural residential]","Building Energy Efficiency Standards - Heating Rural Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,rural residential]","Building Energy Efficiency Standards - Cooling and Ventilation Rural Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[envelope,rural residential]","Building Energy Efficiency Standards - Envelope Rural Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[lighting,rural residential]","Building Energy Efficiency Standards - Lighting Rural Residential",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[appliances,rural residential]","Building Energy Efficiency Standards - Appliances Rural Residential",[0,0.75],"Building Energy Efficiency Standards"),
...
(False,"Reduction in E Use Allowed by Component Eff Std[heating,commercial]","Building Energy Efficiency Standards - Heating Commercial",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,commercial]","Building Energy Efficiency Standards - Cooling and Ventilation Commercial",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[envelope,commercial]","Building Energy Efficiency Standards - Envelope Commercial",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[lighting,commercial]","Building Energy Efficiency Standards - Lighting Commercial",[0,0.75],"Building Energy Efficiency Standards"),
(False,"Reduction in E Use Allowed by Component Eff Std[appliances,commercial]","Building Energy Efficiency Standards - Appliances Commercial",[0,0.75],"Building Energy Efficiency Standards"),
...
(False,"Boolean Ban New Power Plants[lignite es]","Ban New Power Plants - Gangue",[0,1],"Ban New Power Plants"),
(False,"Electricity Sector Fraction of Potential Additional CCS Achieved[hard coal es]","Carbon Capture and Sequestration - Hard Coal",[0,1],"Clean Electricity Standard"),
...
(False,"Electricity Sector Fraction of Potential Additional CCS Achieved[lignite es]","Carbon Capture and Sequestration - Gangue",[0,1],"Clean Electricity Standard"),
...
(False,"Renewable Portfolio Std Percentage","Clean Electricity Standard",[0,0.87],"Clean Electricity Standard"),
...
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[hard coal es]","Non BAU Mandated Capacity Construction - Hard Coal",[0,1],"Non BAU Mandated Capacity Construction"),
...
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[nuclear es]","Non BAU Mandated Capacity Construction - Nuclear",[0,1],"Non BAU Mandated Capacity Construction"),
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[hydro es]","Non BAU Mandated Capacity Construction - Hydro",[0,1],"Non BAU Mandated Capacity Construction"),
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[onshore wind es]","Non BAU Mandated Capacity Construction - Onshore Wind",[0,1],"Non BAU Mandated Capacity Construction"),
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[solar PV es]","Non BAU Mandated Capacity Construction - Solar PV",[0,1],"Non BAU Mandated Capacity Construction"),
...
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[biomass es]","Non BAU Mandated Capacity Construction - Biomass",[0,1],"Non BAU Mandated Capacity Construction"),
...
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[natural gas peaker es]","Non BAU Mandated Capacity Construction - Natural Gas Peaker",[0,1],"Non BAU Mandated Capacity Construction"),
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[lignite es]","Non BAU Mandated Capacity Construction - Gangue",[0,1],"Non BAU Mandated Capacity Construction"),
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[offshore wind es]","Non BAU Mandated Capacity Construction - Offshore Wind",[0,1],"Non BAU Mandated Capacity Construction"),
...
(False,"Boolean Use Non BAU Mandated Capacity Construction Schedule[municipal solid waste es]","Non BAU Mandated Capacity Construction - Municipal Solid Waste",[0,1],"Non BAU Mandated Capacity Construction"),
...
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[refined petroleum and coke 19,energy related emissions]","Carbon Capture and Sequestration - Refined Petroleum and Coke Energy Related Emissions",[0,1],"Industry CCS"),
...
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[chemicals 20,energy related emissions]","Carbon Capture and Sequestration - Chemicals Energy Related Emissions",[0,1],"Industry CCS"),
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[chemicals 20,process emissions]","Carbon Capture and Sequestration - Chemicals Process Emissions",[0,1],"Industry CCS"),
...
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[cement and other nonmetallic minerals 239,energy related emissions]","Carbon Capture and Sequestration - Cement Glass and Other Nonmetallic Minerals Energy Related Emissions",[0,1],"Industry CCS"),
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[cement and other nonmetallic minerals 239,process emissions]","Carbon Capture and Sequestration - Cement Glass and Other Nonmetallic Minerals Process Emissions",[0,1],"Industry CCS"),
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[iron and steel 241,energy related emissions]","Carbon Capture and Sequestration - Iron and Steel Energy Related Emissions",[0,1],"Industry CCS"),
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[iron and steel 241,process emissions]","Carbon Capture and Sequestration - Iron and Steel Process Emissions",[0,1],"Industry CCS"),
...
(False,"Industry Sector Fraction of Potential Additional CCS Achieved[energy pipelines and gas processing 352T353,process emissions]","Carbon Capture and Sequestration - Gas Production and Supply Process Emissions",[0,1],"Industry CCS"),
...
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[agriculture and forestry 01T03,electricity if]","Electrification + Hydrogen (Med n High Temp) - Agriculture and Forestry Shift to Electricity",[0,0.3],"Electrification + Hydrogen"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[agriculture and forestry 01T03,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Agriculture and Forestry Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[coal mining 05,electricity if]","Electrification + Hydrogen (Med n High Temp) - Coal Mining Shift to Electricity",[0,0.3],"Electrification + Hydrogen"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[coal mining 05,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Coal Mining Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[oil and gas extraction 06,electricity if]","Electrification + Hydrogen (Med n High Temp) - Oil and Gas Extraction Shift to Electricity",[0,0.3],"Electrification + Hydrogen"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[oil and gas extraction 06,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Oil and Gas Extraction Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other mining and quarrying 07T08,electricity if]","Electrification + Hydrogen (Med n High Temp) - Other Mining and Quarrying Shift to Electricity",[0,0.3],"Electrification + Hydrogen"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other mining and quarrying 07T08,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Other Mining and Quarrying Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen1"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[food beverage and tobacco 10T12,electricity if]","Electrification + Hydrogen (Med n High Temp) - Food Beverage and Tobacco Shift to Electricity",[0,0.3],"Electrification + Hydrogen1"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[food beverage and tobacco 10T12,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Food Beverage and Tobacco Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen1"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[textiles apparel and leather 13T15,electricity if]","Electrification + Hydrogen (Med n High Temp) - Textiles Apparel and Leather Shift to Electricity",[0,0.3],"Electrification + Hydrogen1"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[textiles apparel and leather 13T15,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Textiles Apparel and Leather Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen1"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[wood products 16,electricity if]","Electrification + Hydrogen (Med n High Temp) - Wood Products and Furniture Shift to Electricity",[0,0.3],"Electrification + Hydrogen1"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[wood products 16,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Wood Products and Furniture Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen1"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[pulp paper and printing 17T18,electricity if]","Electrification + Hydrogen (Med n High Temp) - Pulp Paper and Printing Shift to Electricity",[0,0.3],"Electrification + Hydrogen2"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[pulp paper and printing 17T18,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Pulp Paper and Printing Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen2"),
...
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[refined petroleum and coke 19,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Refined Petroleum and Coke Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen2"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[chemicals 20,electricity if]","Electrification + Hydrogen (Med n High Temp) - Chemicals Shift to Electricity",[0,0.3],"Electrification + Hydrogen2"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[chemicals 20,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Chemicals Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen2"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[rubber and plastic products 22,electricity if]","Electrification + Hydrogen (Med n High Temp) - Rubber and Plastic Products Shift to Electricity",[0,0.3],"Electrification + Hydrogen2"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[rubber and plastic products 22,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Rubber and Plastic Products Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen3"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[glass and glass products 231,electricity if]","Electrification + Hydrogen (Med n High Temp) - Specialized Equipment Manufacturing Shift to Electricity",[0,0.3],"Electrification + Hydrogen3"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[glass and glass products 231,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Specialized Equipment Manufacturing Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen3"),
...
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[cement and other nonmetallic minerals 239,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Cement Glass and Other Nonmetallic Minerals Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen3"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[iron and steel 241,electricity if]","Electrification + Hydrogen (Med n High Temp) - Iron and Steel Shift to Electricity",[0,0.3],"Electrification + Hydrogen3"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[iron and steel 241,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Iron and Steel Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen3"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other metals 242,electricity if]","Electrification + Hydrogen (Med n High Temp) - Other Metals Shift to Electricity",[0,0.3],"Electrification + Hydrogen4"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other metals 242,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Other Metals Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen4"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[metal products except machinery and vehicles 25,electricity if]","Electrification + Hydrogen (Med n High Temp) - Metal Products Except Machinery and Vehicles Shift to Electricity",[0,0.3],"Electrification + Hydrogen4"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[metal products except machinery and vehicles 25,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Metal Products Except Machinery and Vehicles Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen4"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[computers and electronics 26,electricity if]","Electrification + Hydrogen (Med n High Temp) - Computers and Electronics Shift to Electricity",[0,0.3],"Electrification + Hydrogen4"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[computers and electronics 26,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Computers and Electronics Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen4"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[appliances and electrical equipment 27,electricity if]","Electrification + Hydrogen (Med n High Temp) - Appliances and Electrical Equipment Shift to Electricity",[0,0.3],"Electrification + Hydrogen4"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[appliances and electrical equipment 27,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Appliances and Electrical Equipment Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen5"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other machinery 28,electricity if]","Electrification + Hydrogen (Med n High Temp) - Other Machinery Shift to Electricity",[0,0.3],"Electrification + Hydrogen5"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other machinery 28,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Other Machinery Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen5"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[road vehicles 29,electricity if]","Electrification + Hydrogen (Med n High Temp) - Road Vehicles Shift to Electricity",[0,0.3],"Electrification + Hydrogen5"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[road vehicles 29,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Road Vehicles Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen5"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[nonroad vehicles 30,electricity if]","Electrification + Hydrogen (Med n High Temp) - Nonroad Vehicles Shift to Electricity",[0,0.3],"Electrification + Hydrogen5"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[nonroad vehicles 30,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Nonroad Vehicles Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen5"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other manufacturing 31T33,electricity if]","Electrification + Hydrogen (Med n High Temp) - Other Manufacturing Shift to Electricity",[0,0.3],"Electrification + Hydrogen6"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[other manufacturing 31T33,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Other Manufacturing Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen6"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[energy pipelines and gas processing 352T353,electricity if]","Electrification + Hydrogen (Med n High Temp) - Gas Production and Supply Shift to Electricity",[0,0.3],"Electrification + Hydrogen6"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[energy pipelines and gas processing 352T353,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Gas Production and Supply Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen6"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[water and waste 36T39,electricity if]","Electrification + Hydrogen (Med n High Temp) - Water and Waste Shift to Electricity",[0,0.3],"Electrification + Hydrogen6"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[water and waste 36T39,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Water and Waste Shift to Hydrogen",[0,0.2],"Electrification + Hydrogen6"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[construction 41T43,electricity if]","Electrification + Hydrogen (Med n High Temp) - Construction Shift to Electricity",[0,1],"Electrification + Hydrogen6"),
(False,"Fraction of Med and High Temp Industrial Heat Shifted to Other Fuels[construction 41T43,hydrogen if]","Electrification + Hydrogen (Med n High Temp) - Construction Shift to Hydrogen",[0,0.1],"Electrification + Hydrogen6"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[agriculture and forestry 01T03]","Electrification (Low Temp) - Agriculture and Forestry",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[coal mining 05]","Electrification (Low Temp) - Coal Mining",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[oil and gas extraction 06]","Electrification (Low Temp) - Oil and Gas Extraction",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[other mining and quarrying 07T08]","Electrification (Low Temp) - Other Mining and Quarrying",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[food beverage and tobacco 10T12]","Electrification (Low Temp) - Food Beverage and Tobacco",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[textiles apparel and leather 13T15]","Electrification (Low Temp) - Textiles Apparel and Leather",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[wood products 16]","Electrification (Low Temp) - Wood Products and Furniture",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[pulp paper and printing 17T18]","Electrification (Low Temp) - Pulp Paper and Printing",[0,1],"Electrification + Hydrogen - Low1"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[refined petroleum and coke 19]","Electrification (Low Temp) - Refined Petroleum and Coke",[0,1],"Electrification + Hydrogen - Low1"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[chemicals 20]","Electrification (Low Temp) - Chemicals",[0,1],"Electrification + Hydrogen - Low"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[rubber and plastic products 22]","Electrification (Low Temp) - Rubber and Plastic Products",[0,1],"Electrification + Hydrogen - Low1"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[glass and glass products 231]","Electrification (Low Temp) - Specialized Equipment Manufacturing",[0,1],"Electrification + Hydrogen - Low1"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[cement and other nonmetallic minerals 239]","Electrification (Low Temp) - Cement Glass and Other Nonmetallic Minerals",[0,1],"Electrification + Hydrogen - Low1"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[iron and steel 241]","Electrification (Low Temp) - Iron and Steel",[0,1],"Electrification + Hydrogen - Low1"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[other metals 242]","Electrification (Low Temp) - Other Metals",[0,1],"Electrification + Hydrogen - Low1"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[metal products except machinery and vehicles 25]","Electrification (Low Temp) - Metal Products Except Machinery and Vehicles",[0,1],"Electrification + Hydrogen - Low2"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[computers and electronics 26]","Electrification (Low Temp) - Computers and Electronics",[0,1],"Electrification + Hydrogen - Low2"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[appliances and electrical equipment 27]","Electrification (Low Temp) - Appliances and Electrical Equipment",[0,1],"Electrification + Hydrogen - Low2"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[other machinery 28]","Electrification (Low Temp) - Other Machinery",[0,1],"Electrification + Hydrogen - Low2"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[road vehicles 29]","Electrification (Low Temp) - Road Vehicles",[0,1],"Electrification + Hydrogen - Low2"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[nonroad vehicles 30]","Electrification (Low Temp) - Nonroad Vehicles",[0,1],"Electrification + Hydrogen - Low2"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[other manufacturing 31T33]","Electrification (Low Temp) - Other Manufacturing",[0,1],"Electrification + Hydrogen - Low2"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[energy pipelines and gas processing 352T353]","Electrification (Low Temp) - Gas Production and Supply",[0,1],"Electrification + Hydrogen - Low3"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[water and waste 36T39]","Electrification (Low Temp) - Water and Waste",[0,1],"Electrification + Hydrogen - Low3"),
(False,"Fraction of Low Temp Industrial Heat Shifted to Other Fuels[construction 41T43]","Electrification (Low Temp) - Construction",[0,1],"Electrification + Hydrogen - Low3"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[coal mining 05,hard coal if]","Industry Energy Efficiency Standards - Coal Mining Coal Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[coal mining 05,natural gas if]","Industry Energy Efficiency Standards - Coal Mining Natural Gas Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[coal mining 05,biomass if]","Industry Energy Efficiency Standards - Coal Mining Biomass Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[coal mining 05,petroleum diesel if]","Industry Energy Efficiency Standards - Coal Mining Petroleum Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[coal mining 05,crude oil if]","Industry Energy Efficiency Standards - Coal Mining Crude Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[coal mining 05,heavy or residual fuel oil if]","Industry Energy Efficiency Standards - Coal Mining Heavy or Residual Fuel Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[coal mining 05,LPG propane or butane if]","Industry Energy Efficiency Standards - Coal Mining LPG Propane or Butane Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[oil and gas extraction 06,hard coal if]","Industry Energy Efficiency Standards - Oil and Gas Extraction Coal Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[oil and gas extraction 06,natural gas if]","Industry Energy Efficiency Standards - Oil and Gas Extraction Natural Gas Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[oil and gas extraction 06,biomass if]","Industry Energy Efficiency Standards - Oil and Gas Extraction Biomass Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU
biomass Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[road vehicles 29,petroleum diesel if]","Industry Energy Efficiency Standards - Road Vehicles Petroleum Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[road vehicles 29,crude oil if]","Industry Energy Efficiency Standards - Road Vehicles Crude Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[road vehicles 29,heavy or residual fuel oil if]","Industry Energy Efficiency Standards - Road Vehicles Heavy or Residual Fuel Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[road vehicles 29,LPG propane or butane if]","Industry Energy Efficiency Standards - Road Vehicles LPG Propane or Butane Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[nonroad vehicles 30,hard coal if]","Industry Energy Efficiency Standards - Nonroad Vehicles Coal Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[nonroad vehicles 30,natural gas if]","Industry Energy Efficiency Standards - Nonroad Vehicles Natural Gas Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[nonroad vehicles 30,biomass if]","Industry Energy Efficiency Standards - Nonroad Vehicles Biomass Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[nonroad vehicles 30,petroleum diesel if]","Industry Energy Efficiency Standards - Nonroad Vehicles Petroleum Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[nonroad vehicles 30,crude oil if]","Industry Energy Efficiency Standards - Nonroad Vehicles Crude Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[nonroad vehicles 30,heavy or residual fuel oil if]","Industry Energy Efficiency Standards - Nonroad Vehicles Heavy or Residual Fuel Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[nonroad vehicles 30,LPG propane or butane if]","Industry Energy Efficiency Standards - Nonroad Vehicles LPG Propane or Butane Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[energy pipelines and gas processing 352T353,hard coal if]","Industry Energy Efficiency Standards - Gas Production and Supply Coal Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[energy pipelines and gas processing 352T353,natural gas if]","Industry Energy Efficiency Standards - Gas Production and Supply Natural Gas Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[energy pipelines and gas processing 352T353,biomass if]","Industry Energy Efficiency Standards - Gas Production and Supply Biomass Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[energy pipelines and gas processing 352T353,petroleum diesel if]","Industry Energy Efficiency Standards - Gas Production and Supply Petroleum Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[energy pipelines and gas processing 352T353,crude oil if]","Industry Energy Efficiency Standards - Gas Production and Supply Crude Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[energy pipelines and gas processing 352T353,heavy or residual fuel oil if]","Industry Energy Efficiency Standards - Gas Production and Supply Heavy or Residual Fuel Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[energy pipelines and gas processing 352T353,LPG propane or butane if]","Industry Energy Efficiency Standards - Gas Production and Supply LPG Propane or Butane Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[water and waste 36T39,hard coal if]","Industry Energy Efficiency Standards - Water and Waste Coal Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[water and waste 36T39,natural gas if]","Industry Energy Efficiency Standards - Water and Waste Natural Gas Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[water and waste 36T39,biomass if]","Industry Energy Efficiency Standards - Water and Waste Biomass Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[water and waste 36T39,petroleum diesel if]","Industry Energy Efficiency Standards - Water and Waste Petroleum Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[water and waste 36T39,crude oil if]","Industry Energy Efficiency Standards - Water and Waste Crude Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[water and waste 36T39,heavy or residual fuel oil if]","Industry Energy Efficiency Standards - Water and Waste Heavy or Residual Fuel Oil Use",[0,0.25],"Industry Energy Efficiency Standards"),
(False,"Percentage Improvement in Eqpt Efficiency Standards above BAU[water and waste 36T39,LPG propane or butane if]","Industry Energy Efficiency Standards - Water and Waste LPG Propane or Butane Use",[0,0.25],"Industry Energy Efficiency Standards"),
...
(False,"Percent Reduction in Nonenergy Nonagriculture Industry Product Demand[cement and other nonmetallic minerals 239]","Material Efficiency, Longevity, n Re-Use - Cement and Other Nonmetallic Minerals",[0,1],"Material Efficiency, Longevity, n Re-Use"),
(False,"Percent Reduction in Nonenergy Nonagriculture Industry Product Demand[iron and steel 241]","Material Efficiency, Longevity, n Re-Use - Iron and Steel",[0,1],"Material Efficiency, Longevity, n Re-Use"),
...
(False,"Fraction of Forest Restoration Achieved","Forest Restoration",[0,1],"Forest Restoration"),
...
(False,"RnD Electricity Fuel Use Perc Reduction[lignite es]","Fuel Use Reduction - Electricity: Gangue",[0,0.4],"RnD Fuel Use Reductions"),
